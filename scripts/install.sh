...
install() {
    ...
    log "INFO" "Preparing to install $pretty_name on X-Host VPS..." "$GREEN"
...
install_custom() {
    ...
    log "INFO" "Installing $pretty_name on X-Host VPS..." "$GREEN"
...
display_menu() {
    print_main_banner
    printf "\n${YELLOW}Please choose your favorite distro for X-Host VPS:${NC}\n\n"
